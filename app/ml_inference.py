...
class CTScreener:
    ...
    def __init__(
        ...
        gpu_memory: float = float(os.environ.get("GPU_MEMORY_UTILIZATION", 0.94)),
        max_model_len: int = int(os.environ.get("MAX_MODEL_LEN", 6144)),
    ):
    ...
    def run(
        ...
        n_windows: int = int(os.environ.get("N_WINDOWS", 5)),
        threshold: float = 0.2,
    ) -> dict:
        """
